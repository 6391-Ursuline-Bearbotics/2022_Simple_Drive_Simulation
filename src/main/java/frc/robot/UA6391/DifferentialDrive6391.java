 ...
 */
public class DifferentialDrive6391 extends RobotDriveBase6391 implements Sendable, AutoCloseable {
   ...
   */
  public DifferentialDrive6391(SpeedController leftMotor, SpeedController rightMotor) {
  ...
  public void curvatureDrive(double xSpeed, double zRotation, boolean isQuickTurn) {
    ...
    m_rightMotor.set(rightMotorOutput * m_rightSideInvertMultiplier);
  ...
  public void tankDrive(double leftSpeed, double rightSpeed, boolean squareInputs) {
    ...
    leftSpeed = applyDeadband(leftSpeed, m_deadbandForward);

    rightSpeed = MathUtil.clamp(rightSpeed, -1.0, 1.0);
    rightSpeed = applyDeadband(rightSpeed, m_deadbandForward);
    ...
    m_leftMotor.set(leftSpeed * m_maxOutputForward);
    m_rightMotor.set(rightSpeed * m_maxOutputForward * m_rightSideInvertMultiplier);
